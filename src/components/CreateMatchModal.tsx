    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
      <div className="bg-surface-container border border-white/10 rounded-2xl w-full max-w-md overflow-hidden shadow-2xl">
        <div className="p-4 border-b border-white/10 flex items-center justify-between bg-white/5">
          <h3 className="font-headline font-bold text-lg">Tạo trận đấu - Lượt {round}</h3>
        ...
        <div className="p-6 space-y-6">
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full bg-surface-container-highest border border-white/10 rounded-xl px-4 py-3 text-white outline-none focus:border-primary transition-colors"
            >
