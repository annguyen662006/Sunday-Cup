                      ...
                      >
                        ...
                        <td className="px-2 md:px-4 py-3 md:py-4">
                          <div className="flex items-center gap-3 md:gap-4">
                            <div
                              className={cn(
                                'w-8 h-8 md:w-10 md:h-10 rounded-full bg-on-surface/5 flex items-center justify-center border border-on-surface/10 transition-colors shrink-0 overflow-hidden',
                            ...
                            >
                              {getTeamLogo(team.teamId) ? (
                                ...
                                <Shield className="w-5 h-5 md:w-6 md:h-6 text-on-surface/50" />
                              )}
                            </div>
                            <div className="min-w-0">
                              <p className="font-bold text-on-surface font-headline text-sm md:text-base truncate">{getTeamName(team.teamId)}</p>
